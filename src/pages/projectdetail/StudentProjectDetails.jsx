            ...
            <div className="mx-6 md:w-1/3">
              <div className="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div className="mx-4 my-2">
                  <h1 className="text-[#091913] text-justify font-bold text-xs">
                    {Number(proposalData[8])} USDT<span className="mx-2">-</span>30
                  </h1>
                  <h1 className="text-[#091913] text-justify font-normal text-xs">
                    Goal<span className="mx-2">Funders</span>Days left
                  </h1>
                  <div className=" bg-white border-[#2B7C5F]  rounded-full w-3/4 h-2 my-2 ">
                    <div className=" bg-[#2B7C5F] border-[#2B7C5F]  rounded-full w-1/2 h-2 "></div>
                  </div>
                  <h2 className="text-[#091913] text-justify font-normal text-sm">
