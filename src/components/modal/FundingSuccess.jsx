...
const FundingSuccessPage = () => {
  ...
  return (
    <>
      <div className="h-screen flex justify-center items-center bg-[#2B7C5F]">
        ...
        <div className="z-20 md:w-[30%] mt-12 md:mt-0">
          <div className="flex flex-col">
            <form onSubmit={handleSubmit}>
              <div className='mt-8'>
                <h2 className="text-xl font-bold text-[#2B7C5F] text-center mx-2">
                  Fund in
                </h2>
                <span>
                  <select
                    id="currency"
                    class="bg-white border-[#2B7C5F] border-2 rounded w-full py-2 px-3 text-[#2B7C5F] leading-tight focus:outline-none focus:shadow-outline"
                  >
              ...
              <div class="mb-2">
                <label
                  class="block text-[#2B7C5F] text-base font-bold mb-2"
                  for="amount"
                >
                  Price
                </label>
              ...
              <button class="bg-white hover:bg-[#2B7C5F] text-[#2B7C5F] font-bold py-2 px-4 border border-[#2B7C5F] rounded w-full  mb-4">
                Cancel
              </button>
