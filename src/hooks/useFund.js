...
import { getStudentFundContract, getTOKEN } from "../utils/constants/contracts";
    ...
    return useCallback(async (amount, id) => {
        ...
        if (val === 0) {
            try {
                ...
                const transaction1 = await contract1.approve(process.env.REACT_APP_STUDENT_FUND_CONTRACT, amount1
                );
